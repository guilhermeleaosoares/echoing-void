...
def harmonic_axe() -> Sprite:
    """A crystalline war-axe: cohesive socketed head straddling the null-iron haft,
    ...
    sp.stamp([(4, 3), (4, 4), (4, 5), (6, 1), (7, 1)], BISMUTH, 1.0) # cutting edge highlights
    sp.stamp([(12, 5)], BISMUTH, 0.9)                   # back poll highlight
    sp.stamp([(10, 1), (5, 7)], GOLD, 1.0)              # harmonic gold sparks (crest & beard hook)
    return sp
